...
const PinnedStorySection: React.FC = () => {
  ...
  const opacityFade2 = useTransform(scrollYProgress, [0.5, 0.6, 0.85, 0.95], [0, 1, 1, 0]);
  const scale2 = useTransform(scrollYProgress, [0.5, 0.6], [0.8, 1]);
  ...
  return (
    <section id="story" ref={targetRef} className="h-[200vh] bg-stone-950 text-white relative">
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center overflow-hidden">
         ...
         <motion.div style={{ opacity: opacityFade2, scale: scale2 }} className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
